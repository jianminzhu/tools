' XLS_to_CSV_Formulas.vbs
'
' Converts an Excel workbook to a comma-separated text file, preserving formulas.  Requires Microsoft Excel.
' Usage:
'  WScript XLS_to_CSV_Formulas.vbs <input file> <output file>
